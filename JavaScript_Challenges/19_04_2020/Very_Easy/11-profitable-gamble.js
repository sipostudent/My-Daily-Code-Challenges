...
/*
    ...
    To illustrate, profitableGamble(0.2, 50, 9) should yield true, since the net 
    ...
    is calculated in the following manner: net_outcome = probability_of_winning * prize - cost_of_playing.
*/
