...
/*
    ...
    Both the value and the type of parameters need to be tested in order to have an matching 
    ...
    What have you learnt so far that will permit you to do two different checks 
    (value and type) with a single statement?

    Implement a function that returns true if the parameters are equal, and false 
